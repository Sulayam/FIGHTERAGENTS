class ApiService {
  ...
  async sendMessage(ufcfighter, message) {
    try {
      ...
      return this.getFallbackResponse(ufcfighter);
    }
  }

  getFallbackResponse(ufcfighter) {
    return `I'm sorry, ${ufcfighter.name || 'the ufcfighter'} is unavailable at the moment. Please try again later.`;
  }
