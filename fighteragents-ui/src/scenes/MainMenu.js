...
export class MainMenu extends Scene {
    ...
    create() {
        ...
        this.createButton(centerX, startY + buttonSpacing * 2, 'Support Fighteragents', () => {
            window.open('https://github.com/Sulayam/FIGHTERAGENTS', '_blank');
        });
    }
    ...
    addInstructionContent(centerX, centerY, panel) {
        ...
        const instructions = [
            ...
            'SPACE for talking to ufcfighters',
