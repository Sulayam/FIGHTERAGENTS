...
class DialogueManager {
  ...
  async handleEnterKey() {
    if (this.currentMessage.trim() !== '') {
      ...
      if (this.activeUFCFighter.defaultMessage) {
  ...
  async handleDefaultMessage() {
    const apiResponse = this.activeUFCFighter.defaultMessage;
    this.dialogueBox.show('', true);
  ...
  startDialogue(ufcfighter) {
    this.cancelDisconnectTimeout();

    this.activeUFCFighter = ufcfighter;
    this.isTyping = true;
    this.currentMessage = '';
